...
PLANT_DATA["Last Watering"] = np.random.randint(1, 7, PLANT_DATA.shape[0]) * np.random.rand(PLANT_DATA.shape[0]) * 86400000
print(PLANT_DATA.values)
...
ax.scatter(label1["Plant Type"], label1["Water Level"], label1["Last Watering"], c="red")
ax.scatter(label0["Plant Type"], label0["Water Level"], label0["Last Watering"], c="blue")
